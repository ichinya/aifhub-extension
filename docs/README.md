...
| [Ponytail Pi A/B Scenarios](skill-providers-research/ponytail-pi-ab/README.md) | Reproducible 16-case `pi`/Qwen implementation proxy на disposable exact-commit project copies с paired conditions и hidden graders |
