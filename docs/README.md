...
| [Ponytail Pi A/B Scenarios](skill-providers-research/ponytail-pi-ab/README.md) | Reproducible 24-case `pi`/Qwen implementation proxy на disposable exact-commit TypeScript, Go и Laravel project copies с paired conditions и hidden graders |
