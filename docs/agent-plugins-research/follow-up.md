...
Исторический отчёт 2026-09-15 о прямом экспорте трёх skills. Последующее [исправление 2026-09-18](remediation.md) проверяет ограниченный двухskill-профиль и native host MCP binding; исходные результаты ниже не переписываются задним числом.
