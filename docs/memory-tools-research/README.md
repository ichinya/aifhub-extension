...
| context-mode Codex | authorized live follow-up `2026-08-03` | small + >1 MiB + continuity probes | [context-mode-benchmark-results.md](context-mode-benchmark-results.md#authorized-live-follow-up-v10169--2026-08-03), `.ai-factory/state/persist-context-mode-live-evaluation-issue-134/evaluation/live-authorized-evidence.json` | MCP recovered truncated tail facts but used `+120.2%` tokens; small case `+376.8%`; plugin failed nested shell interception; continuity not proven. |
