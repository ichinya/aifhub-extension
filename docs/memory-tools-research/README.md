...
- `tencentdb-agent-memory` не предлагать: user-owned paired pi screening (2026-09-15, omniroute `la/ornith-1.5-35b-a3b`) дал research-выигрыш −26% FTS / −34% EMB без потери качества, но implement-profile негативен (+13% FTS / +29% EMB, до +333%), а capture/purge/daemon границы не проверены; см. [research](tencentdb-agent-memory.md) и [benchmark](tencentdb-agent-memory-benchmark-results.md);
