...
| [context-mode](context-mode.md) | [results](context-mode-benchmark-results.md) | [mksglu/context-mode](https://github.com/mksglu/context-mode) | historical runtime `1.0.151`; static `v1.0.169` | Temporary output/context indexing and optional Codex plugin surface. | Historical manual helper preserved; current MCP/hooks blocked, plugin NOT_RUN; `rg` remains baseline. |
