...
| Profile | language | framework | shape | volume |
|---|---|---|---|---|
| react_micro_tiny | typescript | react+vite | small_microservice | tiny_19_files |
| laravel_app_large | php | laravel | large_framework_app | large_935_files |
| flutter_app_medium | dart | flutter | large_framework_app | medium_229_files |
| unity_app_large | csharp | unity | large_framework_app | large_236_files |
| pyts_monorepo_medium | python+typescript | fastapi+react | monorepo | medium_162_files |
| pyts_fullstack_small | python+typescript | fastapi+react+zustand | polyglot_fullstack | small_85_files |

## Paired Results: FTS-only

Δ = tool относительно baseline (отрицательный = память экономит).

| Profile | Skill | tool | baseline | Δ токенов | Tools T/B | Wall T/B | Грейд T/B |
|---|---|---:|---:|---:|---|---|---|
| react_micro_tiny | research | 11 528 | 15 138 | −23,8% | 2/3 | 18с/22с | 1.00/1.00 |
| react_micro_tiny | implement | 12 155 | 11 554 | +5,2% | 2/3 | 17с/21с | pass/pass |
| laravel_app_large | research | 7 915 | 5 372 | +47,3% | 2/2 | 20с/22с | 1.00/1.00 |
| laravel_app_large | implement | 13 564 | 37 982 | −64,3% | 2/8 | 23с/45с | pass/pass |
| flutter_app_medium | research | 5 609 | 23 296 | −75,9% | 1/7 | 14с/38с | 1.00/1.00 |
| flutter_app_medium | implement | 12 433 | 10 558 | +17,8% | 3/4 | 18с/19с | pass/pass |
| unity_app_large | research | 23 694 | 26 394 | −10,2% | 7/7 | 41с/48с | 1.00/1.00 |
| unity_app_large | implement | 5 439 | 5 778 | −5,9% | 1/2 | 9с/15с | pass/pass |
| pyts_monorepo_medium | research | 25 020 | 31 452 | −20,5% | 7/9 | 40с/54с | 1.00/1.00 |
| pyts_monorepo_medium | implement | 9 973 | 8 182 | +21,9% | 2/3 | 11с/16с | pass/pass |
| pyts_fullstack_small | research | 4 791 | 4 348 | +10,2% | 1/2 | 10с/15с | 1.00/1.00 |
| pyts_fullstack_small | implement | 4 536 | 3 480 | +30,3% | 1/1 | 7с/6с | pass/pass |
...
| Profile | Skill | tool | baseline | Δ токенов | Грейд T/B |
|---|---|---:|---:|---:|---|
| react_micro_tiny | research | 7 100 | 21 620 | −67,2% | 1.00/1.00 |
| react_micro_tiny | implement | 11 608 | 9 603 | +20,9% | pass/pass |
| laravel_app_large | research | 14 382 | 6 348 | +126,6% | 1.00/1.00 |
| laravel_app_large | implement | 11 744 | 25 205 | −53,4% | pass/pass |
| flutter_app_medium | research | 10 282 | 23 005 | −55,3% | 1.00/1.00 |
| flutter_app_medium | implement | 17 489 | 5 781 | +202,5% | pass/pass |
| unity_app_large | research | 17 659 | 19 101 | −7,5% | 1.00/1.00 |
| unity_app_large | implement | 15 438 | 3 569 | +332,6% | pass/pass |
| pyts_monorepo_medium | research | 5 679 | 16 666 | −65,9% | 1.00/1.00 |
| pyts_monorepo_medium | implement | 7 799 | 5 328 | +46,4% | pass/pass |
| pyts_fullstack_small | research | 5 230 | 4 329 | +20,8% | 1.00/1.00 |
| pyts_fullstack_small | implement | 4 544 | 3 525 | +28,9% | pass/pass |
...
| Tiny/small проекты | ❌ pyts_fullstack_small (85 файлов): research +10%, implement +30%. Контекста и так мало. |
