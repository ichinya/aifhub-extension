...
When `.ai-factory/config.yaml` declares `aifhub.tools.openspec: true`, `/aif-explore` is research-oriented and must not create canonical OpenSpec change artifacts.
